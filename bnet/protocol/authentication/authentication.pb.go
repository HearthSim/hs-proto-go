...
type ModuleLoadRequest struct {
	ModuleHandle     *bnet_protocol.ContentHandle `protobuf:"bytes,1,req,name=module_handle" json:"module_handle,omitempty"`
...
type SelectGameAccountRequest struct {
	GameAccount      *bnet_protocol.EntityId `protobuf:"bytes,1,req,name=game_account" json:"game_account,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
